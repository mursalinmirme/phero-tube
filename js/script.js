...
const showCategory = async () => {
    ...
    categories.forEach(element => {
        ...
        div.innerHTML = `
        <button onclick="categoriesShow(${element.category_id})" class="bg-cateBtnBg px-3 py-2 text-base text-cateBtnColor font-medium rounded">${element.category}</button>
        `;
